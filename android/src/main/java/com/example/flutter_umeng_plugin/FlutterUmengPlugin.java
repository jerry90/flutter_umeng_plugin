...
//            MobclickAgent.setPageCollectionMode(MobclickAgent.PageMode.AUTO);
            ...
            new ShareAction(registrar.activity()).withText(shareText).setDisplayList(SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE, SHARE_MEDIA.QQ, SHARE_MEDIA.QZONE)
            ...
            new ShareAction(activity).setDisplayList(SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE, SHARE_MEDIA.QQ, SHARE_MEDIA.QZONE)
                    .withMedia(web)
                    .setCallback(new UmengshareActionListener(activity, result)).open(config);
